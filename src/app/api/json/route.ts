...
export const POST = async (req: NextRequest) => {
  ...
  // Step 2: Create a schema from expected user format
          ...
          messages: [
            {
              role: "assistant",
              content:
                "You are in ai that converts data into attached JSON format. You response with nothing but valid JSON based on input data. Your output should directly be valid JSON, Nothing added before and after. You will begin with the opening curly brace and end with the closing curly brace. Only if you absolutely cannot determine a filed, use the value null.",
            },
            {
              role: "user",
